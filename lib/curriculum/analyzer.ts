...
// DeepSeek enrichment sometimes misclassifies topicType for certain diseases.
// Keyed by diseaseName from enriched JSONL.
// Keep actual drug names (Diltiazem, Atorvastatin, etc.) as DRUG;
// reclassify conditions/side-effects/syndromes/mechanisms tagged as DRUG.
const TOPIC_TYPE_FIXES: Record<string, TopicType> = {
  // diseases tagged as DRUG
  'Abacavir Hypersensitivity Reaction': 'DISEASE',
  'Acetaminophen Toxicity': 'DISEASE',
  'Acne Vulgaris': 'DISEASE',
  'Acute Cholecystitis': 'DISEASE',
  'Acute Coronary Syndrome': 'DISEASE',
  'Acute Decompensated Heart Failure': 'DISEASE',
  'Acute Dystonic Reaction': 'DISEASE',
  'Acute Heart Failure Due To Hypertension': 'DISEASE',
  'Acute Lymphoblastic Leukemia': 'DISEASE',
  'Acute Myocardial Infarction With Heart Failure': 'DISEASE',
  'Acyclovir Nephrotoxicity': 'DISEASE',
  'Age-Related Macular Degeneration (Wet Form)': 'DISEASE',
  'Albuterol-Induced Hypokalemia': 'DISEASE',
  'Anabolic Steroid Abuse': 'DISEASE',
  'Anabolic Steroid Use': 'DISEASE',
  'Androgenic Steroid Abuse': 'DISEASE',
  'Anemia Of Chronic Kidney Disease': 'DISEASE',
  'Anticholinergic Side Effects Of First-Generation Antihistamines': 'DISEASE',
  'Anticholinergic Toxicity': 'DISEASE',
  'Asthma': 'DISEASE',
  'Asthma Exacerbation': 'DISEASE',
  'Asthma/COPD': 'DISEASE',
  'Atrial Fibrillation': 'DISEASE',
  'Bacteroides Infection': 'DISEASE',
  'Benign Prostatic Hyperplasia': 'DISEASE',
  'Beta Blocker Overdose': 'DISEASE',
  'Bisphosphonate-Induced Esophagitis': 'DISEASE',
  'Candidiasis': 'DISEASE',
  'Chemotherapy-Induced Diarrhea': 'DISEASE',
  'Chronic Stable Angina': 'DISEASE',
  'Cocaine Intoxication': 'DISEASE',
  'Constipation': 'DISEASE',
  'Corticosteroid-Induced Leukocytosis': 'DISEASE',
  'Cutaneous Atrophy Due To Topical Corticosteroids': 'DISEASE',
  'Cyanide Toxicity': 'DISEASE',
  'Cyclosporine Nephrotoxicity': 'DISEASE',
  'Deep Venous Thrombosis': 'DISEASE',
  'Digoxin Toxicity': 'DISEASE',
  'Donepezil-Induced Bradyarrhythmia': 'DISEASE',
  'Doxorubicin-Induced Cardiomyopathy': 'DISEASE',
  'Drug-Induced Neutropenia': 'DISEASE',
  ...
  'Exogenous Androgen Use': 'DISEASE',
  'Gallstone Disease (Cholelithiasis)': 'DISEASE',
  'Gastroesophageal Reflux Disease': 'DISEASE',
  'Generalized Anxiety Disorder': 'DISEASE',
  'Gout': 'DISEASE',
  'Graves Disease (Primary Hyperthyroidism)': 'DISEASE',
  'Gynecomastia': 'DISEASE',
  'HIV Infection': 'DISEASE',
  'HIV/AIDS': 'DISEASE',
  'Heart Failure': 'DISEASE',
  'Heart Failure With Reduced Ejection Fraction': 'DISEASE',
  'Hemophilia A': 'DISEASE',
  'Heparin Overdose': 'DISEASE',
  'Hepatic Encephalopathy': 'DISEASE',
  'Hydroxyurea-Induced Pancytopenia': 'DISEASE',
  'Hypercholesterolemia': 'DISEASE',
  'Hyperkalemia': 'DISEASE',
  'Hyperkalemia Due To ACE Inhibitor And Mineralocorticoid Receptor Blocker Interaction': 'DISEASE',
  'Hyperlipidemia': 'DISEASE',
  'Hyperphosphatemia In Chronic Kidney Disease': 'DISEASE',
  'Hypertension': 'DISEASE',
  'Hypertension With Bradycardia And First-Degree AV Block': 'DISEASE',
  'Hypertension With Diabetes And ACE Inhibitor-Induced Cough': 'DISEASE',
  'Hypertension With Migraine': 'DISEASE',
  'Hypertension With Stable Angina': 'DISEASE',
  'Hypertriglyceridemia': 'DISEASE',
  'Hypertriglyceridemia (Drug-Induced)': 'DISEASE',
  'Hypoglycemia': 'DISEASE',
  'Hypoglycemia Due To Sulfonylurea': 'DISEASE',
  'Hypoglycemia Due To Sulfonylurea Overdose': 'DISEASE',
  'Hypokalemia Due To Diuretic Therapy': 'DISEASE',
  'Idiopathic Intracranial Hypertension': 'DISEASE',
  'Infective Endocarditis': 'DISEASE',
  'Influenza': 'DISEASE',
  'Insomnia': 'DISEASE',
  'Invasive Aspergillosis': 'DISEASE',
  'Isoniazid-Induced Peripheral Neuropathy': 'DISEASE',
  'Lithium-Induced Hypothyroidism': 'DISEASE',
  'Lithium Toxicity': 'DISEASE',
  'Major Depressive Disorder': 'DISEASE',
  'Marijuana Intoxication': 'DISEASE',
  'Medication-Induced Constipation': 'DISEASE',
  'Methadone Toxicity': 'DISEASE',
  'Methotrexate Toxicity': 'DISEASE',
  'Monoamine Oxidase Inhibitor (MAOI) Induced Hypertensive Crisis': 'DISEASE',
  'Multiple Myeloma': 'DISEASE',
  'Myocardial Infarction': 'DISEASE',
  'Nitrate-PDE Inhibitor Interaction': 'DISEASE',
  'Non-Hodgkin Lymphoma': 'DISEASE',
  'Non-Hodgkin\'S Lymphoma (CD20+)': 'DISEASE',
  'Non-Small Cell Lung Cancer': 'DISEASE',
  'Nonarteritic Anterior Ischemic Optic Neuropathy (NAION) Due To Sildenafil': 'DISEASE',
  'Norepinephrine Extravasation': 'DISEASE',
  'Obesity': 'DISEASE',
  'Obstructive Hypertrophic Cardiomyopathy With Paroxysmal Atrial Fibrillation': 'DISEASE',
  'Opioid Overdose': 'DISEASE',
  'Opioid Toxicity': 'DISEASE',
  'Opioid Use Disorder': 'DISEASE',
  'Opioid-Induced Constipation': 'DISEASE',
  'Orthostatic Hypotension Due To Clonidine': 'DISEASE',
  'Orthostatic Syncope Due To Clonidine': 'DISEASE',
  'Osteopenia': 'DISEASE',
  'Osteoporosis': 'DISEASE',
  'Osteoporosis Due To Hypogonadism From Leuprolide': 'DISEASE',
  'Ototoxicity': 'DISEASE',
  'Panic Disorder': 'DISEASE',
  'Parkinson Disease': 'DISEASE',
  'Peptic Ulcer Disease': 'DISEASE',
  'Peripheral Arterial Disease': 'DISEASE',
  'Phencyclidine (PCP) Intoxication': 'DISEASE',
  'Phencyclidine Intoxication': 'DISEASE',
  ...
  'Protease Inhibitor-Induced Hyperglycemia': 'DISEASE',
  'Pseudoallergic Reaction To Opioids': 'DISEASE',
  'Radiation-Induced Thyroid Damage': 'DISEASE',
  'Resistant Hypertension': 'DISEASE',
  'Rheumatoid Arthritis': 'DISEASE',
  'Schizophrenia': 'DISEASE',
  'Secondary Malignancy Due To Chemotherapy': 'DISEASE',
  'Septic Shock': 'DISEASE',
  'Sertraline Side Effect': 'DISEASE',
  'Shock': 'DISEASE',
  'Sickle Cell Disease': 'DISEASE',
  'Spironolactone-Induced Gynecomastia': 'DISEASE',
  'Statin-Induced Myopathy': 'DISEASE',
  'Statin-Induced Rhabdomyolysis': 'DISEASE',
  'Sulfonylurea-Induced Hypoglycemia': 'DISEASE',
  'Tenofovir-Induced Nephrotoxicity': 'DISEASE',
  'Testicular Cancer': 'DISEASE',
  'Theophylline Intoxication': 'DISEASE',
  'Thiazide-Induced Hypercalcemia': 'DISEASE',
  'Tricyclic Antidepressant Overdose': 'DISEASE',
  'Tuberculosis': 'DISEASE',
  'Type 2 Diabetes Mellitus': 'DISEASE',
  'Urinary Tract Infection': 'DISEASE',
  'Uterine Fibroids (Leiomyomas)': 'DISEASE',
  'Vancomycin Infusion Reaction': 'DISEASE',
  'Venous Thromboembolism': 'DISEASE',
  'Ventricular Arrhythmia Post-Myocardial Infarction': 'DISEASE',
  'Vitamin D Deficiency Due To Phenytoin': 'DISEASE',
  'Warfarin Overdose': 'DISEASE',
  // principles/concepts tagged as DRUG
  'Antiarrhythmic Drug Classification': 'PRINCIPLE',
  'Aspirin Mechanism Of Action': 'PRINCIPLE',
  'Beta Blocker Effect On ECG': 'PRINCIPLE',
  'Cell Wall Synthesis Inhibition': 'PRINCIPLE',
  'Deep Venous Thrombosis Prophylaxis': 'PRINCIPLE',
  'Dyslipidemia Management': 'PRINCIPLE',
  'Effects Of Fluorinated Inhaled Anesthetics': 'PRINCIPLE',
  'Heparin Anticoagulation': 'PRINCIPLE',
  'Propofol Pharmacokinetics': 'PRINCIPLE',
  'Rh Alloimmunization Prophylaxis': 'PRINCIPLE',
  'Rifampin Resistance': 'CONCEPT',
  'Phenytoin Drug Interaction': 'CONCEPT',
  'Pregnancy Termination': 'CONCEPT',
  'QT Interval Prolongation': 'CONCEPT',
  'Warfarin Interaction With St John\'S Wort': 'CONCEPT',
  'Warfarin-Antibiotic Interaction': 'CONCEPT',
  // syndromes tagged as DRUG
  'Red Man Syndrome': 'SYNDROME',
  'Serotonin Syndrome': 'SYNDROME',
  'Stevens-Johnson Syndrome': 'SYNDROME',
  'Torsade De Pointes': 'SYNDROME',
  // diseases tagged as CONCEPT
  'Acute Myelogenous Leukemia (AML)': 'DISEASE',
  'Atopic Dermatitis': 'DISEASE',
  'Viral Hepatitis': 'DISEASE',
  // syndrome tagged as CONCEPT
  'Dementia': 'SYNDROME',
};
  ...
  // Load enriched questions for topic extraction
  {
    ...
    for (const line of lines) {
      try {
        ...
        const rawType = e.topicType || 'DISEASE';
        const topicType: TopicType = TOPIC_TYPE_FIXES[e.diseaseName] || rawType;
...
export async function getSystemDiseaseMap(): Promise<Record<string, DiseaseEntry[]>> {
  ...
  for (const line of lines) {
    try {
      ...
      const topicType = TOPIC_TYPE_FIXES[e.diseaseName] || e.topicType || 'DISEASE';
